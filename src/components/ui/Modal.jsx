...
const Modal = ({
    ...
    centered,
    scrollContent,
    themeClass = "bg-primary-600 dark:bg-slate-800 dark:border-b dark:border-slate-700",
    title = "",
    uncontrol,
    label = "Basic Modal",
    labelClass,
